...
import { Menu, X, User, Home, LogIn, LogOut, LayoutDashboard,Calendar1  } from "lucide-react";
import "./Navbar.css";
const Navbar = () => {
        ...
        <div className={`fixed bottom-0 left-0 w-full bg-gray-900 text-white p-3 flex justify-around md:hidden transition-all duration-300 ${isOpen ? "block" : "hidden"}`}>
          ...
          {isAuthenticated ? (
            <>
              ...
              <Link to={calendarRoute} className="flex flex-col items-center"><Calendar1 size={24} /><span></span>Calendar</Link>
